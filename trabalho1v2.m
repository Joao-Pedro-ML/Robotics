...
e = ETS3.Rz("q1")*ETS3.Tz(50)*ETS3.Rx("q2")*ETS3.Tx(50)*ETS3.Rx("q3")*ETS3.Tx(50)*ETS3.Rx("q4")*ETS3.Tz(5)*ETS3.Rz("q5");
...
%%
% Definição das posições desejadas para formar o triângulo (A, B, C)

a1 = 1; a2=1;

e = ETS3.Rz("q1")*ETS3.Ry("q2")*ETS3.Tz(a1)*ETS3.Ry("q3")*...
    ETS3.Tz(a2)*ETS3.Rz("q4")*ETS3.Ry("q5")*ETS3.Rz("q6")
